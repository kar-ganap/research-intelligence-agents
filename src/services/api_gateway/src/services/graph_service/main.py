...
def paper_neighbors(paper_id: str):
    ...
    try:
        ...
        for rel in relationships:
            if rel['source_id'] == paper_id:
                # Outgoing relationship
                target_paper = paper_lookup.get(rel['target_id'])
                if target_paper:
                    neighbors.append({
                        'paper_id': rel['target_id'],
            ...
            elif rel['target_id'] == paper_id:
                # Incoming relationship
                source_paper = paper_lookup.get(rel['source_id'])
                if source_paper:
                    neighbors.append({
                        'paper_id': rel['source_id'],
